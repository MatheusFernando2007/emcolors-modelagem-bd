[README.md](https://github.com/user-attachments/files/32263501/README.md)
...
|---|---|---|
| id_cliente | Identificador único do cliente | Obrigatório |
| nome | Nome do cliente (ex: "João Silva") | Obrigatório |
| telefone | Contato do cliente (ex: "(11) 90000-0000") | Obrigatório |
...
| data_pedido | Data em que o orçamento foi solicitado | Obrigatório |
| prazo_entrega | Data prevista de entrega | Varia conforme o pedido |
| status | Situação atual (orçamento, aprovado, em produção, pronto, entregue) | Obrigatório |
| valor_total | Valor total aprovado e pago | Registrado na aprovação |
...
| quantidade_metros | Quantidade solicitada, em metros (ex: 1000) | Obrigatório, sempre em metros |
...
| nome | Tipo de produto (ex: "Adesivo", "Cartão", "Etiqueta") | Obrigatório |

### Tipo_Papel

| Atributo | Descrição | Regra de negócio associada |
|---|---|---|
| id_tipo_papel | Identificador único do tipo de papel | Obrigatório |
| nome | Tipo de papel (ex: "Couché", "Contracolado") | Obrigatório |
...
| nome | Nome do funcionário (ex: "Carlos Souza") | Obrigatório |
| cargo | Função (ex: "Operador de máquina", "Expedicionista", "Gerente", "Administrativo") | Obrigatório |
...
| nome | Nome do fornecedor (ex: "Fornecedora XYZ Papéis") | Obrigatório |
| tipo_insumo | Tipo de insumo fornecido | Cada fornecedor fornece apenas um tipo |

### Insumo

| Atributo | Descrição | Regra de negócio associada |
|---|---|---|
| id_insumo | Identificador único do insumo | Obrigatório |
| nome | Nome do insumo (ex: "Tinta CMYK", "Bobina de papel couché") | Obrigatório |
| quantidade_estoque | Saldo disponível em estoque | Hoje sem controle formal (problema identificado) |
...
<!-- ![DER da EMColors](caminho/para/der.png) -->
